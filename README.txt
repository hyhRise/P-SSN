...
The "construct_reference_network.py" need import"sys","time" and "numpy" module of the python programming language.
...
The "construct_single_network.py" need import "os","sys","time","numpy","scipy" and "multiprocessing" module of the python programming language.
